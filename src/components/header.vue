...
<template>
  ...
  <div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url('+ headBg +')'}">
    <div class="scene">
...
export default {
  data () { // 选项 / 数据
    return {
      ...
      // path:'',//当前打开页面的路径
      input: '', // input输入内容
      headBg: require('@/assets/img/bg_1.jpg'), // 头部背景图
      headTou: '', // 头像
      projectList: '' // 项目列表
    }
  },
